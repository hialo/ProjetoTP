...
public class Camada {
     ...
     * 
     * neuronios: A vector of objects of Neuronio type.
     * saida: A double vector who receives the answer of the MLP.
     * funcao: A object who has the type of the activate function (Hyperbolic Tangent or Sigmoid).
     * erros: A double vector who receives the errors of the training of the neural network.
     */
